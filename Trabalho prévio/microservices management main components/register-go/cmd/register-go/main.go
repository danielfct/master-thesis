...
import (
	...
	"bitbucket.org/cloudedgemicroserviceteam/register-go/util"
	"github.com/gorilla/mux"

	"bitbucket.org/cloudedgemicroserviceteam/register-go/api"
	eureka "bitbucket.org/cloudedgemicroserviceteam/register-go/eurekaops"
	"bitbucket.org/cloudedgemicroserviceteam/register-go/locationutils"

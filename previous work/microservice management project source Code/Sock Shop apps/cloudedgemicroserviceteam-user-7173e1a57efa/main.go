...
import (
	...
	"bitbucket.org/cloudedgemicroserviceteam/go-client-register-go"
	"bitbucket.org/cloudedgemicroserviceteam/user/api"
	"bitbucket.org/cloudedgemicroserviceteam/user/db"
	"bitbucket.org/cloudedgemicroserviceteam/user/db/mongodb"

...
@Configuration
public class RequestLocationRequestInterceptor implements org.springframework.http.client.ClientHttpRequestInterceptor {

	private final MultiValueMap<String, String> headers;

	public RequestLocationRequestInterceptor(DockerProperties dockerProperties) {

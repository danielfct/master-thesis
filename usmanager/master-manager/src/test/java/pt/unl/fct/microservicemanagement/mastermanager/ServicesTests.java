...
public class ServicesTests {
  ...
  public void testGetService(ServiceEntity testService) throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/services/" + testService.getServiceName()))
        ...
        .andExpect(MockMvcResultMatchers.jsonPath("$minReplicas", Matchers.is(testService.getMinReplicas())))
        .andExpect(MockMvcResultMatchers.jsonPath("$maxReplicas", Matchers.is(testService.getMaxReplicas())))

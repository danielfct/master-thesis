package pt.unl.fct.microservicemanagement.mastermanager.manager.rulesystem.rules.service;
...
import pt.unl.fct.microservicemanagement.mastermanager.manager.rulesystem.rules.app.AppRulesService;
...
public class ServiceRulesService {
  ...
  public void addCondition(String ruleName, String conditionName) {
    ...
    var ruleCondition = RuleConditionEntity.builder()
        .serviceRule(rule)
        .condition(condition)
        .build();
  ...
  public ContainerDecisionResult processServiceEvent(String appName, String serviceHostname,
